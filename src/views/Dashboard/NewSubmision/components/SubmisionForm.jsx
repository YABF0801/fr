...
const SubSchema = Yup.object().shape({
	...
	child: Yup.object().shape({ circulo: Yup.object().when('status', {
			is: 'matricula', then: Yup.object().shape({ name: Yup.string(),}),}), 
	}),		
});
...
{/*  ****************************************************** */}		
									...
									<label className='col-md-6 m-md-2 text-secondary' htmlFor="ciPedido">
...
{/*  ****************************************************** */}		
							...
							<div id='os-select' className='row show-form mt-3 mb-3'>
								<h6 className="text-success mb-3">
									SE HA SELECCIONADO ESTA SOLICITUD COMO OTORGAMIENTO SISTEMÁTICO
								</h6>
									<div className="form-group col-md-12 mb-3 d-flex">
									<label className='col-md-7 m-md-2' htmlFor="ciPedido">
